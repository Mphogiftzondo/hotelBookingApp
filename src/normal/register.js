...
const  Register = () => {
  ...
  return (
    ...
    <div class="login-container">
      ...
      <input type="text" placeholder="Enter Email" name="uname" class="name" onChange={(e)=>setEmail(e.target.value) } required/>

       <label for="psw"><b>Password</b></label>
     <input type="password" placeholder="Enter Password" name="psw" class="name" onChange={(e)=>setPassword(e.target.value) } required/>

    <button class="btn" type="submit" onClick={reg}>Sign up</button>
     <label>
